...
interface RadialPressingModalProps {
  isOpen: boolean;
  imageType: string | null;
  onClose: () => void;
}

export default function RadialPressingModal({ isOpen, imageType, onClose }: RadialPressingModalProps) {
  const [currentImageIndex, setCurrentImageIndex] = useState(0);

  const images = [
    { src: '/Радиальноепрессование1.JPG', title: 'Радиальное прессование 1' },
    { src: '/Радиальноепрессование2.JPG', title: 'Радиальное прессование 2' },
    { src: '/Радиальноепрессование3.JPG', title: 'Радиальное прессование 3' },
  ];
