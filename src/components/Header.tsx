      ...
      <nav className="mx-auto max-w-6xl px-3 sm:px-4">
        <div className="h-14 flex items-center gap-2 sm:gap-3">
          ...
          <Sheet open={open} onOpenChange={setOpen}>
            <SheetTrigger asChild>
              <button aria-label="Открыть меню" className="p-2 rounded-md hover:bg-muted transition-colors">
                <Menu className="h-8 w-8 sm:h-9 sm:w-9 text-orange-500" strokeWidth={3} />
              </button>
            </SheetTrigger>
            <SheetContent side="left" className="w-80 sm:w-96 py-4">
              <div className="px-1">
                <div className="max-h-[72vh] overflow-auto pr-2">
                  <ul className="space-y-0.5">
                    {sections.map((s) => (
                      <li key={s.id}>
                        <button
                          className="w-full text-left px-2.5 py-2 rounded-md hover:bg-muted transition-colors text-sm story-link"
          ...
          <div className="flex-1 flex items-center justify-center min-w-0">
            <div className="truncate text-center font-semibold tracking-tight text-orange-500 text-sm sm:text-base px-2">
          ...
          <div className="lg:hidden">
            <button
              ...
              aria-label="Поиск"
            >
              <Search className="h-6 w-6 text-orange-500" strokeWidth={2} />
            </button>
          </div>
        </div>
